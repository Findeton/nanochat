        ...
        save_checkpoint(
            ...
            optimizer.state_dict(),
            {
                ...
                "model_config": {
                    ...
                    "ve_gate_channels": model.config.ve_gate_channels,
                    "episodic_dim": model.config.episodic_dim,
                    "episodic_slots": model.config.episodic_slots,
                    "episodic_decay": model.config.episodic_decay,
                    "episodic_gate_init": model.config.episodic_gate_init,
